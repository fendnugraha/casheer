    ...
    <>
      <div id='content' className='bg-slate-100 max-h-full w-3/4 rounded-xl p-5 overflow-auto'>
        <div className='flex justify-between gap-2'>
          ...
          <input type='search' name='product' id='product-seacrh' placeholder='&#128270; Search product' className='p-2 rounded-lg w-full ring-1 ring-slate-300' onChange={(e) => console.log(e.target.value)} />
