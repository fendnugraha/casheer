...
export default function NavBar() {
    ...
    <div className="sub-nav bg-gray-600 p-3 flex justify-center">
        <ul className="flex gap-3 text-white">
            <li><a href="#" className="hover:text-yellow-100">List of product</a></li>
            <li><a href="#" className="hover:text-yellow-100">Transaction</a></li>
            <li><a href="#" className="hover:text-yellow-100">Report</a></li>
        </ul>
    </div>
        </>
    );
